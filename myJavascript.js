                ...
                if (name == output) {
                    ...
                    try {
                        ...
                        if (tunnit >= aikaT && minuutit >= aikaM || tunnit > aikaT) {
                            ...
                            item = '<div id="contentBox" class="gradie"><img class="image" src="' + pic + '"><img class="rate" src="' + rate + '"><div><a href="' + feedlink + '"><h3>' + movie + '</h3></a><br></div><div class="synopsis"><p>' + synopsis + '</p></div><p><strong>Teatteri: </strong><br><a href="' + feedlink + '">' + theathrename + '</a></p><div class="timeDiv"><p class="time"><strong> Näytösaika: </strong><br>' + time + '</p><p class="genre">' + genre + '</p></div></div>';
                            content += item;
                        } else {
        ...
        if (xmlhttpSchedule.readyState === 4 && xmlhttpSchedule.status === 200) {
            ...
            for (j = 0; j < items.length; j++) {
                ...
                if ((namelower.match(xlower) || genreSearchlower.match(xlower)) && xlower.length != "") {
                    ...
                    if (tunnit >= aikaT && minuutit >= aikaM || tunnit > aikaT) {
                        item = document.getElementById("schedules").innerHTML = '<div id="contentBox" class="gradie"><img class="image" src="' + pic + '"><img class="rate" src="' + rate + '"><div><a href="' + feedlink + '"><h3>' + movie + '</h3></a><br><p><strong>Teatteri: </strong><br><a href="' + feedlink + '">' + theathrename + '</a></p></div><p>' + synopsis + '</p><div class="timeDiv"><p class="time"><strong> Näytösaika: </strong><br>' + time + '</p><p class="genre">' + genre + '</p></div></div>';
                        content += item;
                    } else {
                        // error if no shows today
                        document.getElementById('schedules').innerHTML = '<ul><p class="txtWarning">Ei näytöksiä tänään!</p></ul>';
